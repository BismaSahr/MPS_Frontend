                ...
                <div className="modal-footer">
                    ...
                    <button type="submit" form="batch-form" className="btn-primary" disabled={loading}>
                        {loading ? (
                            ...
                            <><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" className="btn-icon"><line x1="12" y1="5" x2="12" y2="19" /><line x1="5" y1="12" x2="19" /><line x1="5" y1="12" x2="19" y2="12" /></svg>Create Batch</>
                        ) : (
                            <><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="btn-icon"><polyline points="20 6 9 17 4 12" /></svg>Save Changes</>
                        )}
                    </button>
                </div>
            </div>
